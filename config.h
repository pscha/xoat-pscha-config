...
layout layouts[] = {
	...
	{ .spot_start = CURRENT, .spot1_align = RIGHT,  .spot1_width_pct = 34, .spot2_height_pct = 66 }, // primary monitor66//{ .spot_start = SMART, .spot1_align = RIGHT, .spot1_width_pct = 60, .spot2_height_pct = 66 }, // secondary monitor, etc...
};
